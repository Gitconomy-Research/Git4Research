...
3. 关于任务(Task)： 这份PRD的目标读者是谁？是工程师，设计师，还是管理层？他们最关心的信息是什么？
	...
	PM: “好注意![生成式思维层次框架示意图](./../02_参考资料库/课程图表/AI-Dojo-Framework.svg)

*图：生成式思维层次框架示意图*意！写完后我怎么知道它好不好？”
...
![生成式思维层次框架示意图](./../02_参考资料库/课程图表/AI-Dojo-Framework.svg)
...
![生成式思维 vs三大创新理论](./../02_参考资料库/课程图表/AI-with-Innovation-Theories-Comparison.svg)
...
![生成式思维 vs三大创新理论](./../02_参考资料库/课程图表/AI-with-Innovation-Theories-Enablement.svg)
...
![生成式思维的未来](./../02_参考资料库/课程图表/AI-Dojo-Future-Study.svg)
